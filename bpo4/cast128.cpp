...
static const uint8_t K_MAP[sizeof(CAST128::Key)] = {
     3,  2,  1,  0,
     7,  6,  5,  4,
    11, 10,  9,  8,
    15, 14, 13, 12
...
static uint8_t g(const CAST128::Key key, uint8_t i) {
...
void CAST128::encrypt(CAST128::Message msg) {
    run(key, msg);
}

void CAST128::decrypt(CAST128::Message msg) {
    run(key, msg, true);
}
